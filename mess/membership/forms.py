...
#        return data
    ...
    street_address = forms.CharField(required=True, max_length=50)
    city = forms.CharField(required=True, initial="Philadelphia", max_length=50)
    state = forms.CharField(required=True, initial="PA", max_length=50)
    postal_code = forms.CharField(required=True, initial="19143", max_length=20)
    referral_source = forms.ChoiceField(required=False, choices=models.REFERRAL_SOURCES)
    referring_member = forms.CharField(required=False, max_length=50)
