...
urlpatterns = patterns('mess.scheduling.views',
    ...
    url(r'^jobs/descriptions/$', 'job_descriptions', name="job-descriptions"),
    ...
    url(r'^reminder/$', 'reminder', name="scheduling-reminder-today"),
    ...
    url(r'^skills/$', 'skills', name="scheduling-skills"),
    url(r'^skills/descriptions/$', 'skill_descriptions', name="skill-descriptions"),
